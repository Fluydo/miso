...
class MisoBot(commands.Bot):
    ...
    def __init__(self) -> None:
        ...
        intents.members = True          # Required for user status & moderation checks
        intents.message_content = True  # Required for message inspection and utilities

        super().__init__(
            command_prefix="!",         # Slash commands are primary; fallback prefix
            intents=intents,
            help_command=None,
        )
    ...
    async def setup_hook(self) -> None:
        ...
        # Set up global tree error handler
    ...
    async def _force_sync(self) -> dict:
        ...
        for guild_id in config.DEV_GUILD_IDS:
            ...
            try:
                # Clear guild commands first to avoid stale entries
